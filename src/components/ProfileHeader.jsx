...
export default function ProfileHeader({ name, role, streak, avatarUrl, onEdit }) {
  ...
  return (
    <div className="flex items-center p-5 md:p-6 rounded-2xl bg-white/5 backdrop-blur border border-white/10">
      <div className="flex items-center gap-4 md:gap-5 flex-1">
        ...
        <div className="min-w-0">
          ...
          <p className="text-sm text-white/60 mt-1 truncate">{role}</p>
        </div>
      </div>
    </div>
  );
